    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Pepperoni Pizza", 8.99m },
                    { 2, "Deluxe Pizza", 12.99m },
                    { 3, "Meat Lover's Pizza", 10.99m }
                });

            migrationBuilder.InsertData(
                table: "Orders",
                columns: new[] { "Id", "CustomerId", "OrderFulfilled", "OrderPlaced" },
                values: new object[] { 1, 1, new DateTime(2023, 8, 1, 11, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 8, 1, 10, 30, 0, 0, DateTimeKind.Unspecified) });
